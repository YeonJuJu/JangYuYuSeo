...
public class CartController {
	...
	@PostMapping("/insert")
	  public String cartInsertProc (@Valid @ModelAttribute("cartProductDTO") CartProductDTO cartProductDTO,@RequestParam("product_id") int pr_id, HttpSession session) {
		...
		if(loginUserDTO.isUserLogin() == true) {
			...
			cartProductService.addCartProduct(cartProductDTO,cartId);
	...
	@PostMapping("/upate_amount")
	 public String cartPlusProc (@RequestParam("cart_product_id") int cart_pr_id,@RequestParam("amount") int amount) {
