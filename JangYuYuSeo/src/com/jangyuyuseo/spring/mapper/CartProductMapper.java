...
public interface CartProductMapper {
	@Insert("INSERT INTO CART_PRODUCT_TABLE "
			...
			+ "#{pr_amount}, #{pr_color}, #{pr_size},#{pr_image},#{pr_name},#{pr_price},#{total_price})")
	...
	@Update("update cart_product_table set pr_amount = #{amount}, total_price = #{amount}*pr_price where cart_pr_id = #{cart_pr_id}")
