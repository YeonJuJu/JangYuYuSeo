...
public interface UserMapper {
	@Insert("INSERT INTO USER_TABLE VALUES(user_seq.nextval, #{user_name}, #{user_id}, #{user_password}, #{user_address}, #{user_phone}, SYSDATE)")
	public void addUserInfo(UserDTO joinUserDTO);

	@Select("SELECT USER_NAME FROM USER_TABLE WHERE USER_ID = #{user_id}")
	public String checkID(String user_id);

	@Select("SELECT USER_IDX, USER_NAME, USER_ADDRESS, USER_PHONE, TO_CHAR(USER_SIGNUPDATE, 'YYYY-MM-DD') AS USER_SIGNUPDATE FROM USER_TABLE WHERE USER_ID=#{user_id} AND USER_PASSWORD=#{user_password}")
