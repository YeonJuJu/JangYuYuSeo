          ...
          <div class="row">
           ...
           <div class="container">
            	<div class="col-12">
                  ...
                  <div class="col-4">
                      <img class="card-img-top" style="height: 300px; width: 100%; display: block;" src="${pageContext.request.contextPath}/${productDTO.pr_image}" data-holder-rendered="true">
                	</div>
                	<div class="col-8">
                   <div class="card-body" style="margin-left:10px">
                     <h3>${productDTO.pr_name}</h3> 
                     <p class="card-text">${productDTO.pr_description}</p>
                     <p class="card-text"><fmt:formatNumber value="${productDTO.pr_price}" pattern="#,###,###"/> ₩</p>
