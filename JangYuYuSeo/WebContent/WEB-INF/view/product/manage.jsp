				...
				<div class="col-md-4" style="display: inline-block">
					<div class="card mb-4 box-shadow">
						...
						<div class="card-body">
							...
							<p class="card-text">
								<fmt:formatNumber value="${product.pr_price}"
									pattern="#,###,###" />
								₩
							</p>
							...
							<a href="${root }modify?product_id=${product.pr_id}"> <small
								class="text-muted">수정</small>
							</a> <a href="${root }productDelete?product_id=${product.pr_id}">
